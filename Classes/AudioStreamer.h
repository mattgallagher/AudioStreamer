...
typedef enum
{
	...
	AS_FILE_STREAM_SET_PROPERTY_FAILED, //-- SDS: added this to bne used in place of displaying directly an alert
...
- (BOOL)isWaiting;
- (BOOL)isIdle;
- (BOOL)isAborted; //-- SDS: this returns YES if streaming halted due to error (AS_STOPPING + AS_STOPPING_ERROR)
